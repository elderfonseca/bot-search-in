...
export const loginToLinkedIn = async (page: Page): Promise<void> => {
  try {
    await page.goto('https://www.linkedin.com/login', { waitUntil: 'domcontentloaded', timeout: 10000000 });
    ...
    await page.waitForSelector(loginButtonSelector, { timeout: 10000000 });
    ...
    if (!loginButton) {
      ...
      await page.waitForNavigation({ waitUntil: 'domcontentloaded', timeout: 10000000 });
    ...
    await page.waitForSelector('.global-nav__me-photo', { timeout: 10000000 });
